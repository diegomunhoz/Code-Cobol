...
public class ArquivoOutput {
	...
	private void download() {
		...
		chooser.setDialogTitle("SELECIONE O DESTINO DE GRAVA��O");
	...
	private void gravarArquivo(StringBuffer conteudo, String nome)
			throws Exception {
		String c = conteudo + "";
	...
	public void salvarArquivo(List<ArquivoCblTO> list) throws Exception {
		if (list != null && !list.isEmpty()) {
			...
			throw new Exception("N�O EXITE ARQUIVO PARA SER GRAVADO");
		}
	}
